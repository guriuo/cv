...
// --- DATA ---
const navItems = ['Home', 'About', 'Experience', 'Skills', 'Portfolio', 'Testimonials', 'Contact'];
            ...
            <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center h-16">
                ...
                <div className="md:hidden z-[60]">
                    <button onClick={() => setIsOpen(!isOpen)} className="focus:outline-none w-10 h-10 flex items-center justify-center bg-gray-800/50 rounded-md border border-border/50">
                        ...
                        >
                            <motion.span className="block h-0.5 w-full bg-primary rounded-full" variants={{ closed: { rotate: 0, y: 0 }, open: { rotate: 45, y: 7 },}} transition={{ duration: 0.3 }}></motion.span>
                            <motion.span className="block h-0.5 w-full bg-primary rounded-full" variants={{ closed: { opacity: 1 }, open: { opacity: 0 },}} transition={{ duration: 0.1 }}></motion.span>
                            <motion.span className="block h-0.5 w-full bg-primary rounded-full" variants={{ closed: { rotate: 0, y: 0 }, open: { rotate: -45, y: -7 },}} transition={{ duration: 0.3 }}></motion.span>
                        </motion.div>
                    </button>
                </div>
...
const IntroAnimation = ({ onAnimationComplete }: { onAnimationComplete: () => void }) => {
    ...
    return (
        <motion.div className="fixed inset-0 flex items-center justify-center bg-background z-[10000]" initial="hidden" animate="visible" exit={{ opacity: 0, scale: 0.9 }} transition={{ duration: 0.5 }} onAnimationComplete={onAnimationComplete}>
            <motion.h1 className="text-4xl md:text-6xl font-bold text-accent tracking-widest" variants={containerVariants}>
...
const HeroSection = () => (
    <section id="home" className="min-h-screen flex items-center pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 z-10 flex flex-col md:flex-row items-center gap-12">
            <motion.div className="w-48 h-48 md:w-64 md:h-64 relative flex-shrink-0" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.8 }}>
                ...
                <Image src="/profile-avatar.jpg" alt="Mubarik Osman - Professional Avatar" width={256} height={256} className="relative rounded-full object-cover w-full h-full border-4 border-background"/>
            </motion.div>
            <motion.div className="text-center md:text-left" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 1 }}>
...
const AboutSection = () => (
  <motion.section id="about" className="py-16 md:py-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
...
const TimelineSection = () => (
    <motion.section id="experience" className="py-16 md:py-24 bg-gray-800/10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }}>
        <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="relative border-l-2 border-border/50 max-w-3xl mx-auto">
                {timelineEvents.map((event, index) => (
                    <motion.div key={index} className="mb-12 pl-10" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.2 }}>
...
const SkillsSection = () => (
    <motion.section id="skills" className="py-16 md:py-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }}>
        <div className="container mx-auto px-4 sm:px-6">
...
const PortfolioSection = () => {
    ...
    return (
        <motion.section id="portfolio" className="py-16 md:py-24 bg-gray-800/10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }}>
            <div className="container mx-auto px-4 sm:px-6">
...
const TestimonialsSection = () => {
    ...
    return (
        <motion.section id="testimonials" className="py-16 md:py-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }}>
            <div className="container mx-auto px-4 sm:px-6">
...
const ContactSection = () => {
    ...
    return (
        <motion.section id="contact" className="py-20 md:py-28 bg-gray-800/10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }}>
            <div className="container mx-auto px-4 sm:px-6">
